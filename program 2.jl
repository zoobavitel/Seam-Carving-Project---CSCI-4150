...
# Finds energy & how important a pixel is in the image.
...
# normalizes values from range 0 to 1 to help view energy image
...
# Calculates the combined energy needed for each pixel from bottom to top
...
# Generates all carved instances of the original image
...
Text("The image below shows the \"energy\" or how important each pixel is")
...
Text("The image below shows the combined energy needed for a pixel at that position.")
...
Text("Below, the first best seam is marked in red")
